...
import { u as useHead } from './v3-Dh2KFcD9.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-09fd67f7><div class="fixed left-0 right-0 spotlight z-10" data-v-09fd67f7></div><div class="max-w-520px text-center z-20" data-v-09fd67f7><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-09fd67f7>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-09fd67f7>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-09fd67f7>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.21.9_@types+node@24._af9884199a40c4d6f62a97b03a3cb0b9/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-09fd67f7"]]);

export { error404 as default };
//# sourceMappingURL=error-404-COx1fdG5.mjs.map
